 ...
 */
const playReminderSound = async (isMuted: boolean): Promise<void> => {
  if (isMuted) return;
 ...
 */
const playSuccessSound = async (isMuted: boolean): Promise<void> => {
  if (isMuted) return;
 ...
 */
const playWarningSound = async (isMuted: boolean): Promise<void> => {
  if (isMuted) return;
 ...
 */
const playErrorSound = async (isMuted: boolean): Promise<void> => {
  if (isMuted) return;
